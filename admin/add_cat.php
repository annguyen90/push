...
<?php include"../include/siderbar-admin.php" ?>
  ...
  <form id="add_cat" action="" method="post">
  	<fieldset>
        ...
        <div>
            <label for="category">Categorie:<span>*</span>
            	<?php 
            ...
            <input name="category" type="text" value="<?php if(isset($_POST['category'])) echo strip_tags($_POST['category']); ?>" size="20" maxlength="80" tabindex=""/>
       </div>
       <div>
        	<label for="position">Position<samp>*</samp>
            	 <?php 
